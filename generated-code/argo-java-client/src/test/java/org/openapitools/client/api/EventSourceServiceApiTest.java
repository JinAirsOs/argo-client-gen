...
public class EventSourceServiceApiTest {
    ...
    public void eventSourceServiceCreateEventSourceTest() throws ApiException {
        ...
        CreateEventSourceRequest body = null;
        EventSource response = api.eventSourceServiceCreateEventSource(namespace, body);
    ...
    public void eventSourceServiceGetEventSourceTest() throws ApiException {
        String namespace = null;
        String name = null;
        EventSource response = api.eventSourceServiceGetEventSource(namespace, name);
    ...
    public void eventSourceServiceListEventSourcesTest() throws ApiException {
        ...
        EventSourceList response = api.eventSourceServiceListEventSources(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
    ...
    public void eventSourceServiceUpdateEventSourceTest() throws ApiException {
        String namespace = null;
        String name = null;
        UpdateEventSourceRequest body = null;
        EventSource response = api.eventSourceServiceUpdateEventSource(namespace, name, body);
    ...
    public void eventSourceServiceWatchEventSourcesTest() throws ApiException {
        ...
        String listOptionsLimit = null;
        String listOptionsContinue = null;
        Stream_result_of_eventsource_EventSourceWatchEvent response = api.eventSourceServiceWatchEventSources(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
