...
public class ArchivedWorkflowServiceApi {
     ...
     */
    public Workflow archivedWorkflowServiceGetArchivedWorkflow(String uid) throws ApiException {
        ApiResponse<Workflow> localVarResp = archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo(uid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Workflow> archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo(String uid) throws ApiException {
     ...
     */
    public okhttp3.Call archivedWorkflowServiceGetArchivedWorkflowAsync(String uid, final ApiCallback<Workflow> _callback) throws ApiException {
     ...
     */
    public LabelKeys archivedWorkflowServiceListArchivedWorkflowLabelKeys() throws ApiException {
        ApiResponse<LabelKeys> localVarResp = archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<LabelKeys> archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = archivedWorkflowServiceListArchivedWorkflowLabelKeysValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<LabelKeys>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call archivedWorkflowServiceListArchivedWorkflowLabelKeysAsync(final ApiCallback<LabelKeys> _callback) throws ApiException {
     ...
     */
    public LabelValues archivedWorkflowServiceListArchivedWorkflowLabelValues(String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue) throws ApiException {
        ApiResponse<LabelValues> localVarResp = archivedWorkflowServiceListArchivedWorkflowLabelValuesWithHttpInfo(listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
        return localVarResp.getData();
    }
     ...
     * @param listOptionsLimit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned. (optional)
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications. (optional)
     * @return ApiResponse&lt;LabelValues&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<LabelValues> archivedWorkflowServiceListArchivedWorkflowLabelValuesWithHttpInfo(String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<LabelValues>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call archivedWorkflowServiceListArchivedWorkflowLabelValuesAsync(String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue, final ApiCallback<LabelValues> _callback) throws ApiException {
     ...
     */
    public WorkflowList archivedWorkflowServiceListArchivedWorkflows(String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue, String namePrefix) throws ApiException {
        ApiResponse<WorkflowList> localVarResp = archivedWorkflowServiceListArchivedWorkflowsWithHttpInfo(listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, namePrefix);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowList> archivedWorkflowServiceListArchivedWorkflowsWithHttpInfo(String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue, String namePrefix) throws ApiException {
     ...
     */
    public okhttp3.Call archivedWorkflowServiceListArchivedWorkflowsAsync(String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue, String namePrefix, final ApiCallback<WorkflowList> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call archivedWorkflowServiceResubmitArchivedWorkflowCall(String uid, ResubmitArchivedWorkflowRequest body, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call archivedWorkflowServiceResubmitArchivedWorkflowValidateBeforeCall(String uid, ResubmitArchivedWorkflowRequest body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Workflow archivedWorkflowServiceResubmitArchivedWorkflow(String uid, ResubmitArchivedWorkflowRequest body) throws ApiException {
        ApiResponse<Workflow> localVarResp = archivedWorkflowServiceResubmitArchivedWorkflowWithHttpInfo(uid, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Workflow> archivedWorkflowServiceResubmitArchivedWorkflowWithHttpInfo(String uid, ResubmitArchivedWorkflowRequest body) throws ApiException {
     ...
     */
    public okhttp3.Call archivedWorkflowServiceResubmitArchivedWorkflowAsync(String uid, ResubmitArchivedWorkflowRequest body, final ApiCallback<Workflow> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call archivedWorkflowServiceRetryArchivedWorkflowCall(String uid, RetryArchivedWorkflowRequest body, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call archivedWorkflowServiceRetryArchivedWorkflowValidateBeforeCall(String uid, RetryArchivedWorkflowRequest body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Workflow archivedWorkflowServiceRetryArchivedWorkflow(String uid, RetryArchivedWorkflowRequest body) throws ApiException {
        ApiResponse<Workflow> localVarResp = archivedWorkflowServiceRetryArchivedWorkflowWithHttpInfo(uid, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Workflow> archivedWorkflowServiceRetryArchivedWorkflowWithHttpInfo(String uid, RetryArchivedWorkflowRequest body) throws ApiException {
     ...
     */
    public okhttp3.Call archivedWorkflowServiceRetryArchivedWorkflowAsync(String uid, RetryArchivedWorkflowRequest body, final ApiCallback<Workflow> _callback) throws ApiException {
