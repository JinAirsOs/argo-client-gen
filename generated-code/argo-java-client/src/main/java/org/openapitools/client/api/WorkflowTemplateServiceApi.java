...
public class WorkflowTemplateServiceApi {
     ...
     */
    public okhttp3.Call workflowTemplateServiceCreateWorkflowTemplateCall(String namespace, WorkflowTemplateCreateRequest body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call workflowTemplateServiceCreateWorkflowTemplateValidateBeforeCall(String namespace, WorkflowTemplateCreateRequest body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public WorkflowTemplate workflowTemplateServiceCreateWorkflowTemplate(String namespace, WorkflowTemplateCreateRequest body) throws ApiException {
        ApiResponse<WorkflowTemplate> localVarResp = workflowTemplateServiceCreateWorkflowTemplateWithHttpInfo(namespace, body);
     ...
     */
    public ApiResponse<WorkflowTemplate> workflowTemplateServiceCreateWorkflowTemplateWithHttpInfo(String namespace, WorkflowTemplateCreateRequest body) throws ApiException {
     ...
     */
    public okhttp3.Call workflowTemplateServiceCreateWorkflowTemplateAsync(String namespace, WorkflowTemplateCreateRequest body, final ApiCallback<WorkflowTemplate> _callback) throws ApiException {
     ...
     */
    public WorkflowTemplate workflowTemplateServiceGetWorkflowTemplate(String namespace, String name, String getOptionsResourceVersion) throws ApiException {
        ApiResponse<WorkflowTemplate> localVarResp = workflowTemplateServiceGetWorkflowTemplateWithHttpInfo(namespace, name, getOptionsResourceVersion);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowTemplate> workflowTemplateServiceGetWorkflowTemplateWithHttpInfo(String namespace, String name, String getOptionsResourceVersion) throws ApiException {
     ...
     */
    public okhttp3.Call workflowTemplateServiceGetWorkflowTemplateAsync(String namespace, String name, String getOptionsResourceVersion, final ApiCallback<WorkflowTemplate> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call workflowTemplateServiceLintWorkflowTemplateCall(String namespace, WorkflowTemplateLintRequest body, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workflowTemplateServiceLintWorkflowTemplateValidateBeforeCall(String namespace, WorkflowTemplateLintRequest body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public WorkflowTemplate workflowTemplateServiceLintWorkflowTemplate(String namespace, WorkflowTemplateLintRequest body) throws ApiException {
        ApiResponse<WorkflowTemplate> localVarResp = workflowTemplateServiceLintWorkflowTemplateWithHttpInfo(namespace, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowTemplate> workflowTemplateServiceLintWorkflowTemplateWithHttpInfo(String namespace, WorkflowTemplateLintRequest body) throws ApiException {
     ...
     */
    public okhttp3.Call workflowTemplateServiceLintWorkflowTemplateAsync(String namespace, WorkflowTemplateLintRequest body, final ApiCallback<WorkflowTemplate> _callback) throws ApiException {
     ...
     */
    public WorkflowTemplateList workflowTemplateServiceListWorkflowTemplates(String namespace, String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue) throws ApiException {
        ApiResponse<WorkflowTemplateList> localVarResp = workflowTemplateServiceListWorkflowTemplatesWithHttpInfo(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
        return localVarResp.getData();
    }
     ...
     * @param listOptionsLimit limit is a maximum number of responses to return for a list call. If more items exist, the server will set the &#x60;continue&#x60; field on the list metadata to a value that can be used with the same initial query to retrieve the next set of results. Setting a limit may return fewer than the requested amount of items (up to zero items) in the event all requested objects are filtered out and clients should only use the presence of the continue field to determine whether more results are available. Servers may choose not to support the limit argument and will return all of the available results. If limit is specified and the continue field is empty, clients may assume that no more results are available. This field is not supported if watch is true.  The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned. (optional)
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications. (optional)
     * @return ApiResponse&lt;WorkflowTemplateList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WorkflowTemplateList> workflowTemplateServiceListWorkflowTemplatesWithHttpInfo(String namespace, String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<WorkflowTemplateList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call workflowTemplateServiceListWorkflowTemplatesAsync(String namespace, String listOptionsLabelSelector, String listOptionsFieldSelector, Boolean listOptionsWatch, Boolean listOptionsAllowWatchBookmarks, String listOptionsResourceVersion, String listOptionsResourceVersionMatch, String listOptionsTimeoutSeconds, String listOptionsLimit, String listOptionsContinue, final ApiCallback<WorkflowTemplateList> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call workflowTemplateServiceUpdateWorkflowTemplateCall(String namespace, String name, WorkflowTemplateUpdateRequest body, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call workflowTemplateServiceUpdateWorkflowTemplateValidateBeforeCall(String namespace, String name, WorkflowTemplateUpdateRequest body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public WorkflowTemplate workflowTemplateServiceUpdateWorkflowTemplate(String namespace, String name, WorkflowTemplateUpdateRequest body) throws ApiException {
        ApiResponse<WorkflowTemplate> localVarResp = workflowTemplateServiceUpdateWorkflowTemplateWithHttpInfo(namespace, name, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowTemplate> workflowTemplateServiceUpdateWorkflowTemplateWithHttpInfo(String namespace, String name, WorkflowTemplateUpdateRequest body) throws ApiException {
     ...
     */
    public okhttp3.Call workflowTemplateServiceUpdateWorkflowTemplateAsync(String namespace, String name, WorkflowTemplateUpdateRequest body, final ApiCallback<WorkflowTemplate> _callback) throws ApiException {
