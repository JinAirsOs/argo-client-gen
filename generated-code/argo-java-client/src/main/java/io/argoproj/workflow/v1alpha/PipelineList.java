...
public class PipelineList {
  ...
  private List<Pipeline> items = null;
  ...
  public PipelineList items(List<Pipeline> items) {
  ...
  public PipelineList addItemsItem(Pipeline itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Pipeline>();
    }
  ...
  **/
  ...
  public PipelineList metadata(V1ListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PipelineList githubComArgoprojLabsArgoDataflowApiV1alpha1PipelineList = (PipelineList) o;
